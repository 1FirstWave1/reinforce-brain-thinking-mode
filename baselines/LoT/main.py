...
parser.add_argument("--env", default="lot")
parser.add_argument("--seed", default="1")
parser.add_argument("--input", default="data/GSM8K/test.json", choices= ["data/GPQA/gpqa_main.csv","data/TruthfulQA/mc_task.json"])
parser.add_argument("--output", default="data/GSM8K/outputs/output_test.jsonl")
